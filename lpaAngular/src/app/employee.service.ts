...
{ return  this.http.get("http://localhost:8082/lapsusingangular/rest/loans").
    ...
    deleteEmployeeId(data:String): Observable<Employee[]> {
        console.log(data)
        return this.http
            .delete('http://localhost:8082/lapsusingangular/rest/loans/delete/'+data)
            .map((response:Response)=><Employee[]>response.json())
            .catch(this.handleError);
        }
        ...
        addEmployee(data:Employee): Observable<Employee[]> {
            ...
            return this.http
                .post('http://localhost:8082/lapsusingangular/rest/loans/create/',empData,options)
            ...
            searchEmployeeId(data:String): Observable<Employee[]> {
                console.log(data)
                return this.http
                    .get('http://localhost:8082/lapsusingangular/rest/loans/search/'+data)
                    .map((response:Response)=><Employee[]>response.json())
                    .catch(this.handleError);
                }
                ...
                updateEmployee(data:Employee): Observable<Employee[]> {
                    ...
                    return this.http
                        .put('http://localhost:8082/lapsusingangular/rest/loans/update/',empData,options)
                        .map((success => success.status))
                        .catch(this.handleError);
                    }
